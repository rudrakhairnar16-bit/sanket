    ...
    <AppShell>
      <div className="page-container">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <Button variant="primary" icon={<span>+</span>} onClick={() => router.push("/recognition-lab")}>Open Recognition Lab</Button>
        </div>
              ...
              return (
                <Card key={sign.id} variant="spatial" hover className="group">
                  ...
                  <div className="flex gap-2 pt-2 border-t border-white/5">
                    <Button variant="secondary" size="sm" className="flex-1" onClick={() => toast("Edit Sign: Edit functionality coming soon")}>
                      Edit
                    </Button>
                    <Button variant="ghost" size="sm" className="flex-1" onClick={() => toast("Review Sign: Review functionality coming soon")}>
                      Review
                    </Button>
                  </div>
                </Card>
