...
function HomeScreen({
  ...
  return (
    <div className={`max-w-2xl mx-auto px-4 py-6 ${animateIn}`}>
      ...
      {game.streak > 0 && (() => {
        const nextMilestone = getNextStreakMilestone(game.streak);
        return (
          <div className="surface-card p-3 mb-5 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl gradient-accent flex items-center justify-center shrink-0 shadow-glow-accent">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-bold text-surface-900 dark:text-white text-sm">{game.streak} {t("Day Streak")}</p>
              {nextMilestone && (
                <p className="text-[10px] text-surface-500">
                  {nextMilestone.next - game.streak} {t("more days for +")}{nextMilestone.bonus} {t("XP bonus")}
                </p>
              )}
            </div>
