...
export default function StatesPage() {
  ...
  const filtered = (selectedRegion === "All" ? NATIONAL_STATES : getStatesByRegion(selectedRegion))
    ...
    <AppShell>
      <div className="page-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filtered.map((state) => (
            <Card key={state.abbreviation} variant="spatial" hover className="flex flex-col">
