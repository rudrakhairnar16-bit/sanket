      ...
      <div className="page-container">
        ...
        {!selectedPack ? (
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {(camera.cameraState === "denied" || camera.cameraState === "unsupported" || camera.cameraState === "error") && (
                    <Button variant="secondary" size="sm" onClick={() => document.getElementById("manual-sign-tap")?.scrollIntoView({ behavior: "smooth", block: "center" })}>
                      Use Demo Sign Grid
                    </Button>
                  )}
            ...
            <Card>
              <div id="manual-sign-tap" className="flex items-center justify-between mb-3">
