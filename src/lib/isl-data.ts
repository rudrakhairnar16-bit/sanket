...
export const ALL_SIGNS: ISLSign[] = [
  ...
  { id: "yes", name: "Yes", meaning: "Affirmative response", icon: "✊", category: "greetings", hint: "✊ Closed fist, thumb on top — nod fist up/down slightly (NOT open palm)", webcamSupported: true },
  ...
  { id: "wait", name: "Wait", meaning: "Please wait a moment", icon: "✋", category: "office", hint: "✋ Open flat palm facing camera, fingers together, hold still (NOT a fist)", webcamSupported: true },
