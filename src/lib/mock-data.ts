export { mockUsers, findMockUser, getMockLeaderboard } from "./mock-users";
export { mockModules } from "./mock-modules";

export const demoSessions = [
  { _id: "session-1", clerkId: "demo-clerk-1", clerkName: "Ramesh Patel", serviceName: "Water Tax", outcome: "completed", averageConfidence: 0.87, interpreterUsed: false, duration: 45, xpEarned: 25, startedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(), endedAt: new Date(Date.now() - 2 * 60 * 60 * 1000 + 45000).toISOString() },
  { _id: "session-2", clerkId: "demo-clerk-1", clerkName: "Ramesh Patel", serviceName: "Birth Certificate", outcome: "escalated", averageConfidence: 0.32, interpreterUsed: true, duration: 120, xpEarned: 25, startedAt: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(), endedAt: new Date(Date.now() - 5 * 60 * 60 * 1000 + 120000).toISOString() },
  { _id: "session-3", clerkId: "demo-clerk-2", clerkName: "Sita Sharma", serviceName: "Birth Certificate", outcome: "completed", averageConfidence: 0.91, interpreterUsed: false, duration: 35, xpEarned: 25, startedAt: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), endedAt: new Date(Date.now() - 1 * 60 * 60 * 1000 + 35000).toISOString() },
  { _id: "session-4", clerkId: "demo-clerk-3", clerkName: "Amit Shah", serviceName: "Property Tax", outcome: "completed", averageConfidence: 0.78, interpreterUsed: false, duration: 60, xpEarned: 25, startedAt: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(), endedAt: new Date(Date.now() - 3 * 60 * 60 * 1000 + 60000).toISOString() },
  { _id: "session-5", clerkId: "demo-clerk-4", clerkName: "Neha Joshi", serviceName: "Water Tax", outcome: "completed", averageConfidence: 0.82, interpreterUsed: false, duration: 50, xpEarned: 25, startedAt: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(), endedAt: new Date(Date.now() - 4 * 60 * 60 * 1000 + 50000).toISOString() },
];
...
export function getSugamyaScoreData() {
  ...
  return {
    ...
    safetyNet,
    breakdown: {
      compliance: { lessonCompletionRate: compliance, dailyActiveLearners: 4, totalStaff: 4, weight: 0.45 },
      satisfaction: { positiveFeedback, totalFeedback, averageRating: avgRating, weight: 0.30 },
      participation: { activeLearners: 4, totalEnrolled: 4, completions: completedSessions, weight: 0.15 },
